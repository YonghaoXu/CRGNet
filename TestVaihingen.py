...
def get_arguments():
    ...
    parser.add_argument("--restore-from", type=str, default='/iarai/home/yonghao.xu/Code/CRGNet/Exp/Vaihingen/SelfTrain_id_1/time0314_1222/Vaihingen_batch3400mF1_6937.pth',
                        help="restored model.")   
    parser.add_argument("--snapshot_dir", type=str, default='./Result/Vaihingen/',
...
def main():
    ...
    f = open(args.snapshot_dir+'Test_Vaihingen.txt', 'w')
