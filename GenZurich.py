...
def get_arguments():
    ...
    parser.add_argument("--data_dir", type=str, default='/iarai/home/yonghao.xu/Data/Zurich/',
                        help="dataset path.")
    parser.add_argument("--test_list", type=str, default='./dataset/zurich_train.txt',
                        help="test list file.")
    ...
    parser.add_argument("--restore-from", type=str, default='./Zurich_batch2000mF1_6951.pth',
                        help="restored model.")   
    parser.add_argument("--snapshot_dir", type=str, default='/iarai/home/yonghao.xu/Data/Zurich/point/pseudo',
